var load = {
	preload: function() {
        ...
        game.load.image('sky', 'assets/akers1.jpg');
        game.load.image('skymirror', 'assets/akers2.jpg');

        game.load.image('william', 'assets/melk2.png');
        game.load.image('william2', 'assets/melk1.png');

        game.load.image('menu', 'assets/flappyisak.jpg');
